  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/tasks" element={<TaskList tasks={[]} onEdit={function (task: TaskItem): void {
          throw new Error('Function not implemented.');
        } } onDelete={function (taskId: number): void {
          throw new Error('Function not implemented.');
        } } />} />
        <Route path="/kanban" element={<KanbanBoard tasks={[]} onTaskUpdate={function (taskId: number, newStatus: string): void {
          throw new Error('Function not implemented.');
        } } />} />
